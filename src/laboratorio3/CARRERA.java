...
public class CARRERA extends javax.swing.JFrame {
    ...
    public CARRERA() {
        ...
        corredores[0] = new Carro("src/imagen/carro0.png", "Rayo", limite, rayo,0);
        corredores[1] = new Carro("src/imagen/carro1.png", "Cruz", limite, cruz,0);
        corredores[2] = new Carro("src/imagen/carro2.png", "Los Picapiedra", limite, lospicapierda,10); 
        corredores[3] = new Carro("src/imagen/carro3.png", "Francesco", limite, francesco,0);
        corredores[4] = new Carro("src/imagen/carro5.png", "La Maquina Del Misterio", limite, LaMisteryMachine,0);
        corredores[5] = new Carro("src/imagen/carro6.png", "Delorian", limite, Delorian,20);
        corredores[6] = new Carro("src/imagen/carro7.png", "Herbie", limite, Herbie,0); 
        corredores[7] = new Carro("src/imagen/carro4.png", "Sally", limite, Sally,0);
        corredores[8] = new Carro("src/imagen/carro8.png", "Barbie", limite, Barbie,0);
        corredores[9] = new Carro("src/imagen/carro9.png", "Mate", limite, Mate,0);
    ...
    public void correr() 
    {
        ...
        temporizador.scheduleAtFixedRate(tiempo, 0, 101-(velocidad));
    }
